...
The datasets used in this project are raw JSON files for the twits [stocks from [Stock Twits](stocktwits.com), a popular platform dedicated to investors and traders, entrepreneurs.\
